...
HD_PWD='D:/Vivado/cb4cled-jn-application_cleaned/CB4CLED/vhdl/xilinxprj/CB4CLED_Top.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log CB4CLED_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CB4CLED_Top.tcl
