...
HD_PWD='D:/Vivado/cb4cled-jn-application_cleaned/CB4CLED/vhdl/xilinxprj/CB4CLED_Top.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log CB4CLED_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CB4CLED_Top.tcl -notrace
