...
-- rst ASynchronous rst signal, asserted to clear all registers immediately.
...
begin
    ...
    -- rs1D_c: Concurrent assignment
    rs1D <= CSArray(to_integer(unsigned(rs1)));

    -- rs2D_c: Concurrent assignment
    rs2D <= CSArray(to_integer(unsigned(rs2)));
